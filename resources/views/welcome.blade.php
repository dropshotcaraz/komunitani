        ...
        <main class="flex flex-col justify-center items-center self-center px-8 py-20 mt-36 max-w-full text-center bg-white min-h-[482px] rounded-[40px] shadow-[0px_4px_35px_rgba(0,0,0,0.08)] w-[575px] max-md:px-5 max-md:mt-10">
            <div class="flex flex-col max-w-full w-[474px]">
                <div class="flex flex-col max-md:max-w-full">
                    ...
                    <form class="flex flex-col items-center mt-16 w-full h-52 text-base font-bold text-white max-md:mt-10 max-md:max-w-full" action="/login" method="POST">
                        @csrf <!-- Blade directive for CSRF token -->
                        <div class="flex flex-col justify-center max-w-full min-h-[226px] w-[451px]">
                            <button type="submit" class="px-28 pt-3 pb-6 w-full bg-lime-700 rounded-lg shadow min-h-[54px] max-md:px-5 max-md:max-w-full">Log in</button>
                            <button type="button" class="gap-10 self-stretch px-36 py-4 mt-4 w-full whitespace-nowrap bg-lime-700 rounded-lg shadow min-h-[54px] max-md:px-5 max-md:max-w-full">Daftar</button>
