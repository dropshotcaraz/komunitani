            ...
            <div class="bg-white shadow p-4 rounded-3xl mb-10">
                <div class="flex items-center">
                    ...
                    <div class="flex justify-end mt-4">
                        ...
                        <textarea id="postTextarea" placeholder="Tulis pertanyaan atau informasi di sini" class="w-full bg-white-100 p-2 rounded-lg outline-none mb-2 ml-4"></textarea>
                ...
                <div class="bg-white shadow p-4 rounded-3xl mb-6">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <button class="flex items-center text-gray-500 hover:text-yellow-500">
                            <img src={{ Vite::asset('public/images/share.png') }} alt="Share" class="h-6 w-6 mr-2"> Share
                        </button>
                    </div>
                </div>
            </div>
