        ...
        <aside class="col-span-12 md:col-span-2 bg-white h-screen p-6 shadow-lg fixed top-0 left-0 m-4 rounded-3xl">
            ...
            <nav class="space-y-4">
                <a href="#"
                    ...
                    <img src={{ Vite::asset('public/images/homeicon.png') }} alt="Home" class="h-s6 w-6 mr-2">
                    Home
                </a>
                <a href="#"
                    class="block text-lg font-medium text-gray-700 hover:bg-gray-100 p-2 rounded-lg flex items-center">
            ...
            <div class="bg-white shadow-lg p-4 rounded-3xl mb-10 h-screen">
                ...
                <div class="bg-gray-100 shadow p-2 rounded-3xl mb-6 flex items-center">
                    ...
                    <input type="text" placeholder="Search trending topics"
                        class="flex-grow bg-gray-100 p-2 rounded-lg outline-none text-center">
                </div>
                ...
                <!-- REKOMENDASI -->
                <div class="bg-white shadow-pmd p-4 rounded-3xl mb-6 mt-10">
                    <h3>Rekomendasi</h3>
